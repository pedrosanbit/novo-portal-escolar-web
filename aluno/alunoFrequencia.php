...
<html>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="alunoPlanoEnsino.php"><i class="fas fa-chalkboard"></i> Plano de Ensino</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="alunoFrequencia.php"><b><i class="fas fa-calendar-check"></i> Frequência</b></a>
              </li>
              <li class="nav-item">
    ...
    <div id="navtabs">
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="alunoPlanoEnsino.php"><i class="fas fa-chalkboard"></i> Plano de Ensino</b></a>
        </li>
        <li class="nav-item">
        ...
        <?php
          if($_SERVER["REQUEST_METHOD"] == "POST") {
            if(isset($_POST["periodo"]) && $_POST["periodo"] != 'null' && isset($_POST["turma"])) {
              echo "<script>window.location.replace('frequencia.php?turma=".$_POST["turma"]."');</script>";
            }
          }
        ?>
      </form>
