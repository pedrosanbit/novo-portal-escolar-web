...
<html>
    ...
    <nav class="ms-5 mt-2" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="alunoMateriaLecionada.php">Matéria Lecionada</a></li>
      ...
      <?php
        if($_SERVER["REQUEST_METHOD"] != "POST") {
          ...
          try {
            ...
            $stmt = $pdo->prepare("select data, materia from AulasTCC where codTurma = :codTurma and codDisc = :codDisc and data < :data");
            $stmt->bindParam(":codTurma", $_GET["turma"]);
